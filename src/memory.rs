// Allow dead code as for now this allows to keep memory command unused without clippy warnings
#![allow(dead_code)]
use embassy_stm32::qspi::{enums::*, Instance, Qspi, QuadDma, TransferConfig};
...
pub struct FlashMemory<I: Instance, D: QuadDma<I>> {
    qspi: &'static mut Qspi<'static, I, D>,
}

impl<I: Instance, D: QuadDma<I>> FlashMemory<I, D> {
    pub fn new(qspi: &'static mut Qspi<'static, I, D>) -> Self {
